                        ...
                        <div class="nest" id="validationClose">
                            ...
                            <div class="body-nest" id="validation">
                                <div class="form_center">
                                    <form action="<?php echo e(route('models.store')); ?>" id="contact-form" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <fieldset>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Development\xampp\htdocs\onsiterepair\resources\views/dashboard/add-technician.blade.php ENDPATH**/ ?>
