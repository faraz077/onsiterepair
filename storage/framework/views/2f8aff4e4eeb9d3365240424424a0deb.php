													...
													<table id="footable-res2" class="demo table" data-filter="#filter" data-filter-text-only="true">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo e(route('reg-technician.show', $technician->id)); ?>"><?php echo e($technician->name); ?></a></td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <a href="<?php echo e(route('reg-technician.edit', $technician->id)); ?>" class="btn btn-info">Edit</a>
                                                                </td>
                                                                <td>
                                                                    <form action="<?php echo e(route('reg-technician.destroy', $technician->id)); ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this technician?')">
                                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Development\xampp\htdocs\onsiterepair\resources\views/dashboard/technician/technician.blade.php ENDPATH**/ ?>