		...
		<div class="row">
			...
			<div class="col-lg-10">
				...
				<table class="table">
                    ...
                    <?php $__currentLoopData = $comp_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
