                                ...
                                <table id="footable-res2" class="demo table" data-filter="#filter" data-filter-text-only="true">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo e(route('models.edit', $model->id)); ?>" class="btn btn-info">Edit</a></td>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\work1\onsiterepair\resources\views/dashboard/device-model/models.blade.php ENDPATH**/ ?>