                        ...
                        <div class="nest" id="validationClose">
                            ...
                            <div class="body-nest" id="validation">
                                <div class="form_center">
                                    <form action="{{ route('reg-technician.update', $technician->id) }}" id="contact-form" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <fieldset>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="name" id="name" value="{{ $technician->name }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="email" id="email" value="{{ $technician->email }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control" name="address" id="address" value="{{ $technician->address }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    @if($technician->image)
                                                        <p>Existing Image:</p>
                                                        <img src="{{ asset('public/images/technicians/' . $technician->image) }}" alt="{{ $technician->name }}" style="max-width: 200px; max-height: 200px;">
                                                    @else
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    @if($technician->cnic_front)
                                                        <p>Existing Image:</p>
                                                        <img src="{{ asset('public/images/technicians/cnic/' . $technician->cnic_front) }}" alt="{{ $technician->name }}" style="max-width: 200px; max-height: 200px;">
                                                    @else
                                                        <p>No existing image</p>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    @if($technician->cnic_back)
                                                        <p>Existing Image:</p>
                                                        <img src="{{ asset('public/images/technicians/cnic/' . $technician->cnic_back) }}" alt="{{ $technician->name }}" style="max-width: 200px; max-height: 200px;">
                                                    @else
                                                        <p>No existing image</p>
                                                    @endif
                                                </div>
